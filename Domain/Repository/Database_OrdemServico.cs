                ...
                using (var tran = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        os.Id = conn.ExecuteScalar<int>(sqlOrdemServico, new
                        {
                            ...
                            Garantia = string.IsNullOrWhiteSpace(os.DuracaoGarantia) ? (object)DBNull.Value : os.DuracaoGarantia,
                            InicioGarantia = string.IsNullOrWhiteSpace(os.DtInicioGarantia) ? (object)DBNull.Value : os.DtInicioGarantia,
                            FimGarantia = string.IsNullOrWhiteSpace(os.DtFimGarantia) ? (object)DBNull.Value : os.DtFimGarantia,
            ...
            using (var conn = new SQLiteConnection(_conn.GetConnections()))
            {
                ...
                try
                {
                    ...
                    .Select(x => new OrdemServico
                    {
                        ...
                        Status = (int)x.Status,
                        DuracaoGarantia = x.Garantia,
                        DataEntrada = x.DataEntrada,
                        FimPrevisto = x.FimPrevisto,
                        FimReal = x.FimReal,
                        DtInicioGarantia = x.InicioGarantia,
                        DtFimGarantia = x.FimGarantia,
                        MaoObra = x.MaoObra,
